-- =============================================================================
--  VHDL simulation model generated by IPExpress    11/25/2016    13:42:30         
--  Filename: spi_loopback_top_la0_sim.vhd                                          
...
entity spi_loopback_top_la0 is
    PORT (
        clk:		IN std_logic;
        ...
        trace_din:	IN std_logic_vector (70 downto 0);
        trigger_en:	IN std_logic;
        ip_enable:	IN std_logic
    );

end spi_loopback_top_la0;

architecture spi_loopback_top_la0_u of spi_loopback_top_la0 is
begin

    er2_tdo <= '0';

end spi_loopback_top_la0_u;
